<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="address" label="分组" align="center"></el-table-column>
      <el-table-column prop="jun" label="登陆IP" align="center"></el-table-column>
  ...
  width="30%"
  center>
  <div class="create"><span>账号</span> <input type="text" ></div>
   <div class="create"><span>密码</span> <input type="text" ></div>
    <div class="create"><span>分组</span> 
